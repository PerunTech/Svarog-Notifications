...
class SearchComponent extends React.Component {
  ...
  handleSearch = () => {
    ...
    const url = `${window.server}/message_module/MsgServices/searchSubjects/${svSession}`
    ...
    axios(reqConfig).then(res => {
      if (title === '' && text === '' && category === '' && priority === '') {
        ...
        if (res && res.data) {
          ...
          const gridConfig = `/message_module/MsgServices/getTableFieldList/${svSession}/${tableName}`
